              ...
              <SidebarMenuItem key={item.title}>
                <SidebarMenuButton
                  ...
                  className={cn(
                    ...
                    isActive &&
                      "relative overflow-visible bg-gradient-to-l from-orange-400/0 to-amber-500/20"
                  )}
                >
                  <Link
                    to={item.url}
                    className={cn("group relative", isActive && "font-medium")}
                  >
                    ...
                    {isActive && (
                      <span className="absolute inset-0 -z-10 rounded-md bg-orange-50" />
                    )}
                  </Link>
                </SidebarMenuButton>
              </SidebarMenuItem>
